package mesquite.ToLEditor.ToLExtinctListAssistant;
...
/* ======================================================================== */
public class ToLExtinctListAssistant extends TaxonListAssistant {
	Taxa taxa;
	MesquiteTable table=null;
	NameReference anr = NameReference.getNameReference("ToLExtinct");
	MesquiteMenuItemSpec extinctMenuID, extantMenuID;
	...
	public void setTableAndTaxa(MesquiteTable table, Taxa taxa){
		...
		this.table = table;
		deleteMenuItem(extinctMenuID);
		deleteMenuItem(extantMenuID);
		extinctMenuID = addMenuItem("Extinct", makeCommand("extinct", this));
		extantMenuID = addMenuItem("Not Extinct", makeCommand("extant", this));
	}
	/*...............................................................................................................*/
	...
	/*.................................................................................................................*/
	private void setExtinctionStatus(boolean extinct){
	...
	public Object doCommand(String commandName, String arguments, CommandChecker checker) {
		if (checker.compare(this.getClass(), "Sets the taxon to be extinct", null, commandName, "extinct")) {
			setExtinctionStatus(true);	
		}
		else
			if (checker.compare(this.getClass(), "Sets the taxon to be extant", null, commandName, "extant")) {
				setExtinctionStatus(false);	
			}
			else
	...
	public String getStringForTaxon(int it){
		if (taxa!=null) {
			boolean extinct = taxa.getAssociatedBit(anr, it);
			if (extinct)
				return "extinct";
			else
				return "-";
	...
	public String getExplanation() {
		return "Lists whether a taxon is a extinct or not as indicated in the Tree of Life Web Project." ;
	}
}
